        ...
        <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
						<form action="#" class="billing-form bg-light p-3 p-md-5">
							<h3 class="mb-4 billing-heading">Dados da Cobrança</h3>
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-md-6">
	                  ...
	                  <input required type="text" name="logradouro" class="form-control" placeholder="Nome da rua e número da casa">
	                </div>
	          		...
	          		<div class="cart-detail bg-light p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Método de Pagamento</h3>
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2"> Boleto Bancário</label>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2"> Cartão de Dédito</label>
											</div>
										</div>
									</div>
